...
fun initalCountries():Array<Country>
{
    ...
    return arrayOf<Country>(
        ...
        Country("Japan","known for the orange man",126,2,"/drawable/japan_flag","/raw/japan_anthem")
    )
}
...
fun initalHistoryEvents(): Array<CountryHistoryEvent>
{
    return arrayOf<CountryHistoryEvent>(
        CountryHistoryEvent(1, Date(1954,7,5),"Algeria","Algeria became a free nation after several years of revolution against the french"),
        CountryHistoryEvent(2, Date(1945,11,1),"Algeria","Algeria started its revolution against the french nation"),

        CountryHistoryEvent(3, Date(1917,3,8),"Russia","The Russian Revolution was a period of political and social revolution across the territory of the Russian Empire, commencing with the abolition of the monarchy in 1917, and concluding in 1923 after the Bolshevik establishment of the Soviet Union at the end of the Civil War."),
        CountryHistoryEvent(4, Date(1945,11,1),"Russia","President Franklin Roosevelt ended almost 16 years of American non-recognition of the Soviet Union following a series of negotiations in Washington, D.C. with the Soviet Commissar for Foreign Affairs, Maxim Litvinov."),

        CountryHistoryEvent(5, Date(1945,8,6),"Japan","an American B-29 bomber dropped the world's first deployed atomic bomb over the Japanese city of Hiroshima. The explosion wiped out 90 percent of the city and immediately killed 80,000 people"),
        CountryHistoryEvent(6, Date(1941,12,7),"Japan","The Attack on Pearl Harbor was a surprise military strike by the Imperial Japanese Navy Air Service upon the United States against the naval base at Pearl Harbor in Honolulu, Territory of Hawaii, just before 08:00, on Sunday morning")
    )
}
...
fun initalCountryImgs():Array<CountryImg>
{
    return arrayOf(
        ...
        CountryImg(1,"Algeria","/drawable/algeria_image2"),

        CountryImg(1,"Russia","/drawable/russia_image1"),
        CountryImg(1,"Russia","/drawable/russia_image2"),

        CountryImg(1,"Japan","/drawable/japan_image1"),
        CountryImg(1,"Japan","/drawable/japan_image2")
...
fun initalCountryVideos():Array<CountryVideo>
{
    return arrayOf(
        ...
        CountryVideo(1,"Algeria","/drawable/algeria_vid2"),

        CountryVideo(1,"Russia","/drawable/russia_vid1"),
        CountryVideo(1,"Russia","/drawable/russia_vid2"),

        CountryVideo(1,"Japan","/drawable/japan_vid1"),
        CountryVideo(1,"Japan","/drawable/japan_vid2")
...
{
    return arrayOf(
        Personnality(1,"Algeria",Date(1923,6,10),Date(1954,3,4),"El Arbi Ben Mhidi"
        ...
        Personnality(2,"Algeria",Date(1889,12,4),Date(1940,4,16),"Abd El Hamid Ibn Badis"
        ...
        Personnality(3,"Russia",Date(1952,10,7),null,"Vladimir Putin"
        ...
        Personnality(4,"Russia",Date(1878,12,18),Date(1953,3,5),"Joseph Stalin"
        ...
        Personnality(5,"Algeria",Date(1944,11,20),null,"Koko Kondo"
        ...
        Personnality(6,"Algeria",Date(1896,11,13),Date(1987,8,7),"Nobusuke Kishi"
...
fun initalRessources(): Array<Ressource>?
{
    return arrayOf(
        Ressource(1,"Russia","Coasts",37653.0),
        Ressource(2,"Russia","Natural Gas",10.0),
        Ressource(3,"Russia","Oil",80.0),

        Ressource(4,"Algeria","Coasts",1622.0),
        Ressource(4,"Algeria","Oil",12200.0),
        Ressource(4,"Algeria","Natural Gas",159.0),

        Ressource(4,"Japan","Coasts",29751.0)
    )
}
